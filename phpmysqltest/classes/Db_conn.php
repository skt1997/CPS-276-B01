...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'sthiels';//this will be your WCC username
      $dbUsr = 'sthiels';//this will be your WCC username
      $dbPass = 'q832fzXxvrHa';//this will be the password found in the video.
